...
import ConfigureClass from './ConfigureHotspot';

import { NavigationScreenProps } from 'react-navigation';
import { mockData } from '../../../../constants';


interface ConfigureClassContainerProps extends NavigationScreenProps {
...
const ConfigureClassContainer = (props: ConfigureClassContainerProps) => {
  const {
