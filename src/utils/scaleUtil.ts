...
const widthPercentage = (percent: number) => (percent * SCREEN_WIDTH) / 100;
const heightPercentage = (percent: number) => (percent * SCREEN_HEIGHT) / 100;

export { widthPercentage, heightPercentage };
export default (size: number) => size * SCALE;
